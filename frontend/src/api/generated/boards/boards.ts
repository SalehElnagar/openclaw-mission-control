 ...
 * @summary Ensure Board Lead
 */
export type ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse200 = {
  data: AgentRead;
  status: 200;
};

export type ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse422 = {
  data: HTTPValidationError;
  status: 422;
};

export type ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponseSuccess =
  ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse200 & {
    headers: Headers;
  };
export type ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponseError =
  ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse422 & {
    headers: Headers;
  };

export type ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse =
  | ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponseSuccess
  | ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponseError;

export const getEnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostUrl = (
  boardId: string,
) => {
  return `/api/v1/boards/${boardId}/lead/ensure`;
};

export const ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost = async (
  boardId: string,
  options?: RequestInit,
): Promise<ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse> => {
  return customFetch<ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePostResponse>(
    getEnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostUrl(boardId),
    {
      ...options,
      method: "POST",
    },
...
export const getEnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostMutationOptions =
  <TError = HTTPValidationError, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
      Awaited<
        ReturnType<typeof ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost>
      >,
      TError,
      { boardId: string },
      TContext
    ...
    Awaited<ReturnType<typeof ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost>>,
    TError,
    { boardId: string },
    TContext
  > => {
    const mutationKey = ["ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost"];
    const { mutation: mutationOptions, request: requestOptions } = options
      ? options.mutation &&
        "mutationKey" in options.mutation &&
        options.mutation.mutationKey
    ...
    > = (props) => {
      ...
      return ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost(
        boardId,
        requestOptions,
      );
    };
...
export type EnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostMutationResult =
  NonNullable<
    Awaited<ReturnType<typeof ensureBoardLeadApiV1BoardsBoardIdLeadEnsurePost>>
  >;

export type EnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostMutationError =
  HTTPValidationError;

/**
 * @summary Ensure Board Lead
 */
export const useEnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePost = <
  TError = HTTPValidationError,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getEnsureBoardLeadApiV1BoardsBoardIdLeadEnsurePostMutationOptions(options),
    queryClient,
  );
};
/**
