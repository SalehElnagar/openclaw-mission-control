        ...
        <div className="space-y-6">
          <section className="rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] p-6 shadow-sm">
            ...
            <form onSubmit={handleSave} className="mt-6 space-y-5">
              ...
              {saveError ? (
                <div className="rounded-lg border border-[color:var(--danger)]/40 bg-[color:var(--danger)]/10 p-3 text-sm text-[color:var(--danger)]">
                  {saveError}
                </div>
              ) : null}
              {saveSuccess ? (
                <div className="rounded-lg border border-emerald-400/40 bg-emerald-400/10 p-3 text-sm text-emerald-700 dark:text-emerald-300">
                  {saveSuccess}
                </div>
              ) : null}
          ...
          <section className="rounded-xl border border-[color:var(--danger)]/35 bg-[color:var(--danger)]/10 p-6 shadow-sm">
