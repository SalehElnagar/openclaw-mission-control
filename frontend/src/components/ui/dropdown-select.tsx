    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <button
          ...
          disabled={disabled}
          className={cn(
            "inline-flex h-10 w-auto cursor-pointer items-center justify-between gap-2 rounded-md border border-[color:var(--border)] bg-[color:var(--surface)] px-3 py-2 text-sm font-medium text-strong shadow-sm transition-colors hover:bg-[color:var(--surface-muted)] focus:outline-none focus:ring-2 focus:ring-[color:var(--accent)] focus:border-transparent disabled:cursor-not-allowed disabled:opacity-50",
            ...
            {options.map((option) => {
              ...
              return (
                <CommandItem
                  ...
                  className={cn(
                    "flex items-center justify-between gap-2 rounded-lg px-4 py-3 text-sm text-muted transition-colors data-[selected=true]:bg-[color:var(--surface-muted)] data-[selected=true]:text-strong",
                    isSelected && "font-semibold",
                    !isSelected && "hover:bg-[color:var(--surface-muted)]",
                    itemClassName,
                  )}
                >
