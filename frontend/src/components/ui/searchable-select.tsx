...
const baseTriggerClassName =
  "w-auto h-auto rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] px-4 py-3 text-left text-sm font-semibold text-muted shadow-sm transition-all duration-200 hover:border-[color:var(--border-strong)] hover:text-strong focus:border-[color:var(--accent)] focus:ring-4 focus:ring-[color:var(--accent-soft)]";
const baseContentClassName =
  "rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] shadow-xl";
